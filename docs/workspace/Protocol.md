...
Global validation verifies the coherence of a locally-validated node, in the context of the whole blockchain, including the node.
...
* *HEAD*: the BINDEX top entry (generated for incoming node, precisely)
